  ...
  return (
    <main>
        ...
        <div>
          <PortableText
            ...
            serializers={{
              ...
              li: (props: any) => <h1 className="text-xl font-bold my-5" {...props} />,

              h2: (props: any) => <li className="ml-4 list-disc" {...props} />,
      ...
      {submitted ? (
        ...
        <form className="flex flex-col p-5 max-w-2xl mx-auto mb-10" onSubmit={onSubmit}>
          ...
          {/* errors will return when filed validation fails */}
